...
import { showFormMsg, mealInputMsg, caloriesInputMsg, saveMealMsg, editMealMsg, deleteMealMsg } from './Update'
...
function fieldSet(labelText, inputValue, oninput) {
    return div(
        [
            label({ className: 'db mb-1' }, labelText),
            input({
...
function formView(dispatch, model) {
    ...
    return button(
        {
            className: 'f3 pv2 ph3 bg-blue white bn pointer',
